            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: 'var(--ink-3)', marginTop: 2 }}>
                  Avg ${pattern.data.topAvg} this month
                </div>
              </div>
            </div>
                ...
                >
                  <div style={{ flex: 1, width: '100%', display: 'flex', alignItems: 'flex-end' }}>
                    <div style={{
                      ...
                      background: day.highlight ? 'var(--primary)' : 'var(--surface-2)',
                  ...
                  <div style={{
                    fontSize: 9,
                    color: day.highlight ? 'var(--primary)' : 'var(--ink-3)',
                    fontFamily: 'var(--font-mono)',
                    fontWeight: day.highlight ? 600 : 400
                  }}>
                    {day.day}
                  </div>
                </div>
